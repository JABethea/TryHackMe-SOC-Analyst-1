...
**Description:**
The Blue Team is the defensive force — the people and processes that detect, respond to, and limit damage from attacks. The Blue Team operate the Security Operations Center (SOC), build detections, tune tools, and collaborate with other cybersecurity teams (e.g. Red Team, CIRT, GRC). The Blue Team’s job is to keep attackers out, spot them fast when they get in, and remediate effectively.
...
* **Manager** — Operational oversight, staffing, KPIs.
  Outside SOC, a **CIRT**/CSIRT ("firefighters") handles full-scale incidents and forensics. There are also specialized defensive roles like DevSecOps, Pen Testers, GRC Auditors, AppSec Engineers, Threat Analysts, and AI Researchers.
...
**Description:**
The room’s final interactive challenge places you in the CISO chair, assigning roles to incidents. It tests your understanding of which team should respond to each incident type.
...
**Description:**
This room gives maps out the Blue Team and provides a roadmap from foundational L1 SOC to L2, and beyond to more specializaed positions. Clarification is given on internal SOCs and MSSPs, shows where CIRT fits, and lays out the career path and skill-building steps to accelerate your progress. 
*End of document.*
